...
import com.jalilov.mathtime.databinding.ActivityDividedBinding;


public class DividedActivity extends AppCompatActivity {

    private ActivityDividedBinding binding;


    DividedGame game = new DividedGame();
    ...
    MediaPlayer wrongAnswer, correctAnswer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDividedBinding.inflate(getLayoutInflater());
...
//        startTimer();
        ...
        View.OnTouchListener answerButtonListener = (v, event) -> {
            ...
            int realAnswer = game.getDividedQuestion().getAnswer();
            ...
            if (realAnswer == answerSelected) {
                ...
                wrongAnswer.start();
                game.checkLife(timer, DividedActivity.this);
    ...
    public void nextTurn(View v) {
        ...
        game.makeQuestion();
        int[] answer = game.getDividedQuestion().getAnswerArray();
        ...
        binding.setQuestion.setText(game.getDividedQuestion().getQuestionPhrase());
    ...
    public void startTimer() {
        timer = new CountDownTimer(40000, 1000) {
            ...
            public void onFinish() {
                ...
                game.sendScore(DividedActivity.this);
            }
        }.start();
