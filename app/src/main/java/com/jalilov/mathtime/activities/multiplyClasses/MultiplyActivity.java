...
import com.jalilov.mathtime.databinding.ActivityMultiplyBinding;

public class MultiplyActivity extends AppCompatActivity {

    private ActivityMultiplyBinding binding;

    MultiplyGame game = new MultiplyGame();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMultiplyBinding.inflate(getLayoutInflater());
...
//        startTimer();
        ...
        View.OnTouchListener answerButtonListener = (v, event) -> {
            ...
            if (realAnswer == answerSelected) {
                ...
                wrongAnswer.start();
                game.checkLife(timer, MultiplyActivity.this);
    ...
    public void startTimer() {
        timer = new CountDownTimer(40000, 1000) {
            ...
            public void onFinish() {
               ...
               game.sendScore(MultiplyActivity.this);
            }
        }.start();
